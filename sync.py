...
# מחירון ידני — עלות ללא מע"מ לפי שם מוצר
# ממוין מהארוך לקצר: התאמה ספציפית יותר תנצח
PRICE_LIST = sorted([
    ('בעקיטשעע פירחוני ביטנה מלאה', 237.60),
    ('בעקיטשעע פירחוני חצי ביטנה',  229.68),
    ('בעקיטשעע פירחוני מלכותי',      277.20),
    ('בעקיטשעע פירחוני מסי',         534.60),
    ('בעקיטשעע חלק ביטנה מלאה',      249.48),
    ('בעקיטשעע חלק חצי ביטנה',       229.68),
    # כתיב חלופי מה-DB
    ('בעקיטשע פרחוני ביטנה מלאה',   237.60),
    ('בעקיטשע פרחוני חצי ביטנה',    229.68),
    ('בעקיטשע פרחוני מלכותי',        277.20),
    ('בעקיטשע פרחוני משי',           534.60),
    ("ראז'וויאלקעע ביטנה מלאה",      277.20),
    ("ראז'וויאלקעע חצי ביטנה",       229.68),
    ("ראז'וואלקע ביטנה מלאה",        277.20),
    ("ראז'וואלקע חצי ביטנה",         229.68),
    ('מעיל חורף קשמיר',              1405.80),
    ('מעיל חורף צמר',                415.80),
    ('ריפס אמריקאי ביטנה מלאה',      237.60),
    ('ריפס אמריקאי חצי ביטנה',       229.68),
    ('חליפה ביטנה מלאה 3 חלקים',     495.00),
    ('חליפה רבני ביטנה מלאה',        237.60),
    ('חליפה רבני חצי ביטנה',         229.68),
    ('חליפה חצי ביטנה',              182.16),
    ('חלאט ירושלמי חצי ביטנה',       253.44),
    ('מעיל חורף פרווה',              316.80),
    ('מעיל חורף רבני',               415.80),
    ('מעיל חורף פוך',                316.80),
    ('וועסט שבת לבן',                178.20),
    ('וועסט שבת',                    99.00),
    ('שבת חלאט',                     99.00),
    ('מכנס רבני',                    316.80),
    ('מכנס צמר',                     138.60),
